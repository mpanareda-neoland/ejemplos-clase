...
function new_page_dynamic(pagenum: number, content: string) {
...
function load_example_advanced(items: Item[]) {
...
function new_page_advanced(pagenum: number, content: Item[]) {
  // Creamos el div en tab-content
  var new_tab = $("<div/>");
  new_tab
    .addClass(["tab-pane", "container"])
  ...
  content.forEach(function(item: Item) {
